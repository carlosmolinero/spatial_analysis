...
double ShapeFile::calculateDistanceLatLon(Point2d coordinatesLonLat1,Point2d coordinatesLonLat2){//haversine formula
    double lon1=coordinatesLonLat1.x;
    double lat1=coordinatesLonLat1.y;
    double lon2=coordinatesLonLat2.x;
    double lat2=coordinatesLonLat2.y;
    double R=6378137;
    double inc_lat=lat2-lat1;
    double inc_lat_rad=inc_lat/180*M_PI;
    double inc_lon=lon2-lon1;
...
// void ShapeFile::readGeoTiffDensityPeopleAndSaveResult(std::string pathFile,std::string pathOutput){
//
//
//
// }
